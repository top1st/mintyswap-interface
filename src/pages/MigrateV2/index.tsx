      ...
      <BodyWrapper style={{ padding: 24 }}>
        <AutoColumn gap="16px">
          <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
            ...
            <div>
              <QuestionHelper text={<Trans>Migrate your liquidity tokens from Mintyswap V2 to Mintyswap V3.</Trans>} />
            </div>
          </AutoRow>

          <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
            <Trans>
              For each pool shown below, click migrate to remove your liquidity from Mintyswap V2 and deposit it into
              Mintyswap V3.
            </Trans>
          </TYPE.body>
