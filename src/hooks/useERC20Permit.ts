...
import { DAI, MINTYS, USDC } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [MINTYS[1].address]: { type: PermitType.AMOUNT, name: 'Mintyswap' },
  },
  [4]: {
    ['0xc7AD46e0b8a400Bb3C915120d284AafbA8fc4735']: { type: PermitType.ALLOWED, name: 'Dai Stablecoin', version: '1' },
    [MINTYS[4].address]: { type: PermitType.AMOUNT, name: 'Mintyswap' },
  },
  [3]: {
    [MINTYS[3].address]: { type: PermitType.AMOUNT, name: 'Mintyswap' },
    ['0x07865c6E87B9F70255377e024ace6630C1Eaa37F']: { type: PermitType.AMOUNT, name: 'USD Coin', version: '2' },
  },
  [5]: {
    [MINTYS[5].address]: { type: PermitType.AMOUNT, name: 'Mintyswap' },
  },
  [42]: {
    [MINTYS[42].address]: { type: PermitType.AMOUNT, name: 'Mintyswap' },
  },
}
