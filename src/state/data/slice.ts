...
const CHAIN_SUBGRAPH_URL: Record<number, string> = {
  [SupportedChainId.MAINNET]: 'https://api.thegraph.com/subgraphs/name/top1st/mintyswap-v3-info',
  [SupportedChainId.RINKEBY]: 'https://api.thegraph.com/subgraphs/name/top1st/mintyswap-v3-rinkeby',
